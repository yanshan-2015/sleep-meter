  ...
  getwx();
    ...
    getData('http://zs.derucci.net/deruccimid/sleep/findcusinfo', ajaxData).then(function(json,e) {
      ...
      $.get('../map/' + cityMap[city] + '.json', function(Json) {
        ...
        myChart.setOption(option(stores(arr),city));
    ...
    function stores(arr){
      ...
      for(let i=0;i<arr.length;i++){
        let obj = {
          name: arr[i].CUSCOMPANY+'~'+arr[i].CUSTOMERADDS,
          value: [arr[i].LONGITUDE, arr[i].LATITUDE]
        }
        temp.push(obj);
      }
      return temp;
    ...
    //定义option
    function option(stores,city){
      return {
        backgroundColor: '#efeff4', //bgColor变量在common.js定义
        geo: {
          map: city,
          roam: true,
          zoom: 1.2,
